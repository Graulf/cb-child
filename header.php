...
<head>
<meta name="google-site-verification" content="cPzTIRNt9YpzFg5UVwfr-sO1m8C19p6DM0dNTXyosdQ" />
	...
	if ( is_page() ):
		...
		switch ($sticky_header):
			...
			case 'Sticky Navbar Only':
				echo '<div id="sticky-header" class="navbar-only">';
				get_template_part('navbar', 'content');
				echo '</div>';
				break;
			...
			case 'Sticky Navbar on scroll':
				echo '<div id="sticky-header" class="navbar-only"></div>';
				break;
...
<div id="langC"><ul><?php pll_the_languages(array('show_flags'=>1,'show_names'=>0,'hide_current'=>1));?></ul></div> 
<?php
