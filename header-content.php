...
<div id="header"><div class="container"><div id="logo"><a href="<?php echo home_url(); ?>"><?php
   ...
   <h2>Solutions based on experience and commitment</h2>
   <?php
} else { ?>
    <h2>Lösningar byggda på engagemang och erfarenhet</h2>
    <?php
}?>
</div>
        
        <!-- <div id="header-right"><?php echo $icefit_options['header_custom_HTML']; ?></div> -->
