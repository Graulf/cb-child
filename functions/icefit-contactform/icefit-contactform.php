...
function icefit_contact_intl() {
	$intl_mess['noname'] = __("Var vänlig och skriv ditt namn.", 'icefit');
	$intl_mess['nomail'] = __("Var vänlig och skriv din e-postadress.", 'icefit');
	$intl_mess['invalidmail'] = __("Skriv gärna en giltig e-postadress.", 'icefit');
	$intl_mess['nomess'] = __("Skriv vad du vill?.", 'icefit');
	$intl_mess['success'] = __("Tack! Ditt meddelande har skickats till oss!.", 'icefit');
	$intl_mess['failure'] = __("Tyvärr blev det något fel när du försökte skicka, prova igen!", 'icefit');
	return $intl_mess;
}
